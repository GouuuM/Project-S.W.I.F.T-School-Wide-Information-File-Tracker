...
public class Student extends User {
    ...
    public boolean handleChoice(int choice, Scanner sc) {
        try {
            switch (choice) {
                case 1 -> {
                    String subjectCode = utility.InputHelper.getStringInput("Enter subject code to enroll: ");
                ...
                case 2 -> {
                    String answer = utility.InputHelper.getStringInput("Enter your answer for assignment: ");
                    FileManager.addEntry("submitted_assignments_" + getUsername() + ".txt", sc, "Answer: " + answer);
                }
                case 3 -> {
                    String assignmentToRemove = utility.InputHelper.getStringInput("Enter assignment title to remove: ");
