...
public class SchoolData {
    ...
    private static final String ACTIVITIES_FILE = "activities_data.txt";
    ...
    private static <T> void saveData(String filename, Function<T, String> formatter, List<T> dataList) {
    ...
    public static void loadLessons() {
        loadData(LESSONS_FILE, parts ->
                        parts.length == 2 ? new LessonPlan(parts[0].trim(), parts[1].trim()) : null,
                lessons);
    }
