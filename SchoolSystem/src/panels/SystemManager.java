...
public class SystemManager {
    ...
    public void run() {
        ...
        if (loggedInStudent != null) {
            StudentPanel.run(loggedInStudent);
    ...
    private void register() {
        ...
        String username = InputHelper.getStringInput("Choose a username: ");
        String password = InputHelper.getStringInput("Choose a password: ");
